...
const Navbar = ({ onCTA }) => {
  ...
  return (
    <header style={{
      ...
      {/* Top bar */}
      <div style={{ background: var_orange, padding: "6px 24px", textAlign: "center" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: "60px" }}>
        ...
        <nav style={{ display: "flex", gap: "20px", overflow: "hidden" }}>
          {sections.slice(0, 5).map(s => (
            <a key={s} href={`#${s.toLowerCase().replace(/ /g, "-")}`} style={{ fontSize: "13px", color: "#374151", textDecoration: "none", fontWeight: 500, whiteSpace: "nowrap" }}
              onMouseEnter={e => e.target.style.color = var_orange}
        ...
        {/* CTA */}
        <button onClick={onCTA} style={{ background: var_orange, color: "#fff", border: "none", borderRadius: "8px", padding: "10px 20px", fontWeight: 700, fontSize: "14px", cursor: "pointer", whiteSpace: "nowrap" }}>
          Request callback
        </button>
      </div>
    </header>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1, display: "flex", gap: "60px", alignItems: "flex-start", flexWrap: "wrap" }}>
        ...
        <div style={{ flex: "1 1 420px" }}>
          ...
          <h1 style={{ color: "#fff", fontWeight: 900, fontSize: "clamp(26px,4vw,42px)", lineHeight: 1.15, marginBottom: "16px" }}>
            ...
            <span style={{ color: var_orange }}>GenAI & Multi Agent Systems</span><br />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginBottom: "32px" }}>
            {[
              { icon: "", text: "Get Industry ready hands-on projects with Coding Ninjas & IBM" },
              { icon: "", text: "Expert-led classes with doubt support by Coding Ninjas & IBM" },
              { icon: "", text: "Curriculum co-designed by Experts of AI startup & IBM" },
            ].map((f, i) => (
          ...
          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
            {[
              ...
              <div key={i} style={{ flex: "1 1 120px", background: "#1a1a1a", border: "1px solid #2a2a2a", borderRadius: "10px", padding: "12px", textAlign: "center" }}>
                <p style={{ color: var_orange, fontWeight: 900, fontSize: "22px", lineHeight: 1 }}>{s.stat}</p>
          ...
          {submitted ? (
            ...
            <>
              ...
              <button onClick={submit} style={{
                width: "100%", background: var_orange, color: "#fff", border: "none",
                ...
                onMouseLeave={e => e.currentTarget.style.background = var_orange}>
        ...
        {tabs.map(t => (
          <a key={t.id} href={`#${t.id}`} onClick={() => setActive(t.id)}
            style={{
              ...
              color: active === t.id ? var_orange : "#6b7280",
              borderBottom: active === t.id ? `2px solid ${var_orange}` : "2px solid transparent",
  ...
  <div style={{ background: "linear-gradient(135deg, #0f172a 0%, #1e293b 100%)", padding: "48px 24px" }}>
    <div style={{ maxWidth: "1000px", margin: "0 auto", textAlign: "center" }}>
      <h2 style={{ color: "#fff", fontWeight: 900, fontSize: "clamp(22px,3.5vw,36px)", marginBottom: "24px" }}>
        Future Proof Your career with <span style={{ color: var_orange }}>GenAI Skills</span>
      </h2>
  ...
  return (
    <section id="curriculum" style={{ padding: "72px 24px", background: "#fff" }}>
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        <h2 style={{ fontWeight: 900, fontSize: "clamp(24px,3.5vw,38px)", marginBottom: "8px" }}>Industry ready in <span style={{ color: var_orange }}>6 months</span></h2>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          {modules.map((m, i) => (
            <div key={i} style={{ border: "1px solid #e5e7eb", borderRadius: "12px", overflow: "hidden" }}>
              <button 
                onClick={() => {
                  console.log('Clicked module:', i, 'Current open:', openModules);
                  setOpenModules(prev => ({
                    ...prev,
                    [i]: !prev[i]
                  }));
                }}
                className={`w-full flex justify-between items-center px-5 py-4.5 text-left cursor-pointer transition-all duration-200 outline-none border border-transparent ${
                  openModules[i] 
                    ? 'bg-orange-50 hover:bg-orange-100' 
                    : 'bg-white hover:bg-gray-50'
                }`}>
                <span style={{ fontWeight: 700, fontSize: "15px", color: "#111" }}>{m.title}</span>
                <span style={{ fontSize: "20px", color: var_orange, transition: "transform 0.2s", transform: openModules[i] ? "rotate(45deg)" : "rotate(0)" }}>+</span>
              </button>
              {openModules[i] && (
                  ...
                  <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "8px" }}>
                    {m.lessons.map((l, j) => (
                      <li key={j} style={{ display: "flex", alignItems: "center", gap: "10px", fontSize: "14px", color: "#374151" }}>
                        <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: var_orange, flexShrink: 0 }} />
                        {l}
                      </li>
                    ))}
                  </ul>
...
const GenAIAdvantage = () => {
  ...
  return (
    <section id="genai-advantage" style={{ background: "#0d0d0d", padding: "72px 24px" }}>
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        <p style={{ color: var_orange, fontSize: "12px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "12px" }}>THE CODING WORLD IS EVOLVING</p>
        <h2 style={{ color: "#fff", fontWeight: 900, fontSize: "clamp(24px,3.5vw,38px)", marginBottom: "48px" }}>
          Stay on top with <span style={{ color: var_orange }}>Gen AI</span>
        </h2>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: "20px" }}>
          {cards.map((c, i) => (
            <div key={i} style={{ background: "#141414", border: "1px solid #2a2a2a", borderRadius: "16px", padding: "28px 24px", transition: "border-color 0.2s" }}
              onMouseEnter={e => e.currentTarget.style.borderColor = var_orange}
  ...
  return (
    <section id="career-support" style={{ background: "#fff", padding: "72px 24px" }}>
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        <h2 style={{ fontWeight: 900, fontSize: "clamp(24px,3.5vw,38px)", marginBottom: "48px" }}>
          Helping you become <span style={{ color: var_orange }}>industry ready</span>
        </h2>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: "20px" }}>
          {services.map((s, i) => (
    ...
    <section style={{ background: "#f9fafb", padding: "72px 24px" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        <h2 style={{ fontWeight: 900, fontSize: "clamp(22px,3vw,34px)", marginBottom: "8px", textAlign: "center" }}>
          Your one stop destination to <span style={{ color: var_orange }}>code, create & connect</span>
        </h2>
  ...
  return (
    <section id="faculty" style={{ background: "#0d0d0d", padding: "72px 24px" }}>
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <h2 style={{ color: "#fff", fontWeight: 900, fontSize: "clamp(24px,3.5vw,38px)", marginBottom: "48px" }}>
          Learn from the best <span style={{ color: var_orange }}>in the industry</span>
        </h2>
  ...
  return (
    <section id="testimonials" style={{ background: "#fff", padding: "72px 24px" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <h2 style={{ fontWeight: 900, fontSize: "clamp(24px,3.5vw,38px)", marginBottom: "48px" }}>
          Hear what our <span style={{ color: var_orange }}>students</span> have to say
        </h2>
            ...
            <div key={i} style={{ background: "#f9fafb", border: "1px solid #e5e7eb", borderRadius: "16px", padding: "24px", position: "relative" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: "12px", color: var_orange, fontWeight: 600 }}>{r.company}</p>
                </div>
              </div>
            </div>
          ))}
  ...
  return (
    <section id="plans" style={{ background: "linear-gradient(135deg, #0d0d0d 0%, #1a1a1a 100%)", padding: "72px 24px" }}>
      <div style={{ maxWidth: "600px", margin: "0 auto", textAlign: "center" }}>
        ...
        <h2 style={{ color: "#fff", fontWeight: 900, fontSize: "clamp(24px,3.5vw,38px)", marginBottom: "48px" }}>
          One plan for <span style={{ color: var_orange }}>every learner</span>
        </h2>
        ...
        <div style={{ background: "#141414", border: "1px solid #2a2a2a", borderRadius: "20px", padding: "36px", textAlign: "left" }}>
          ...
          <div style={{ borderTop: "1px solid #2a2a2a", paddingTop: "24px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "16px" }}>
            ...
            <button onClick={onCTA} style={{ background: var_orange, color: "#fff", border: "none", borderRadius: "10px", padding: "14px 32px", fontWeight: 700, fontSize: "16px", cursor: "pointer" }}
              onMouseEnter={e => e.currentTarget.style.background = "#c94e22"}
              onMouseLeave={e => e.currentTarget.style.background = var_orange}>
              Apply now
            </button>
  ...
  return (
    <section id="contact" style={{ background: "#f9fafb", padding: "72px 24px" }}>
      <div style={{ maxWidth: "560px", margin: "0 auto" }}>
        ...
        <h2 style={{ fontWeight: 900, fontSize: "clamp(24px,3.5vw,36px)", marginBottom: "8px" }}>We are here to <span style={{ color: var_orange }}>help you out</span></h2>
        ...
        {done ? (
          <div style={{ textAlign: "center", padding: "40px", background: "#fff", borderRadius: "16px", border: "1px solid #e5e7eb" }}>
            <div style={{ fontSize: "48px", marginBottom: "12px" }}> </div>
            <h3 style={{ fontWeight: 700, fontSize: "20px", color: "#111", marginBottom: "8px" }}>Submitted!</h3>
          ...
          <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: "16px", padding: "32px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
            ...
            <button onClick={submit} style={{ width: "100%", background: var_orange, color: "#fff", border: "none", borderRadius: "8px", padding: "14px", fontWeight: 700, fontSize: "15px", cursor: "pointer" }}
              onMouseEnter={e => e.currentTarget.style.background = "#c94e22"}
              onMouseLeave={e => e.currentTarget.style.background = var_orange}>
              Request callback
            </button>
  ...
  return (
    <section id="faqs" style={{ background: "#fff", padding: "72px 24px" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <h2 style={{ fontWeight: 900, fontSize: "clamp(24px,3.5vw,38px)", marginBottom: "48px" }}>
          Here's what you <span style={{ color: var_orange }}>need to know</span>
        </h2>
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          {faqs.map((f, i) => (
            <div key={i} style={{ border: "1px solid #e5e7eb", borderRadius: "12px", overflow: "hidden" }}>
              <button onClick={() => setOpen(open === i ? null : i)}
                ...
                <span style={{ fontSize: "20px", color: var_orange, flexShrink: 0, transition: "transform 0.2s", transform: open === i ? "rotate(45deg)" : "rotate(0)", marginTop: "2px" }}>+</span>
              </button>
              {open === i && (
    ...
    <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: "32px", marginBottom: "40px" }}>
        ...
        <div>
          ...
          <p style={{ color: "#6b7280", fontSize: "12px" }}>contact@codingninjas.com</p>
        </div>
    ...
    <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 200, background: "#fff", borderTop: "1px solid #e5e7eb", boxShadow: "0 -4px 20px rgba(0,0,0,0.1)", padding: "12px 24px" }}>
      <div style={{ maxWidth: "900px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        ...
        <div style={{ display: "flex", gap: "12px" }}>
          ...
          <button onClick={onCTA} style={{ background: var_orange, color: "#fff", border: "none", borderRadius: "8px", padding: "10px 24px", fontWeight: 700, fontSize: "14px", cursor: "pointer" }}>
            Apply now 
          </button>
        </div>
      </div>
...
/* Root App Component */
export default function IBMGenAIPage() {
